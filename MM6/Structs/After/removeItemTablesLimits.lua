...
local callWhenGameInitialized, checkIndex, makeMemoryTogglerTable, getSlot, getSpellQueueData = E.callWhenGameInitialized, E.checkIndex, E.makeMemoryTogglerTable, E.getSlot, E.getSpellQueueData
...
local testItemGeneration, tryGetItem, tryGetMouseItem, tryGetStdBonus, tryGetSpcBonus = assert(E.tests.testItemGeneration), assert(E.tests.tryGetItem), assert(E.tests.tryGetMouseItem), assert(E.tests.tryGetStdBonus), assert(E.tests.tryGetSpcBonus)

local arrayFieldOffsetName, npcArrayFieldOffsetName, processRawAddresses, printSortedArraysData, processReferencesTable = assert(E.arrayFieldOffsetName), assert(E.npcArrayFieldOffsetName), assert(E.processRawAddresses), assert(E.printSortedArraysData), assert(E.processReferencesTable)
...
local replacePtrs, processReferencesTable = assert(E.replacePtrs), assert(E.processReferencesTable)
